  ...
  return (
    <nav className="h-16 lg:h-20 flex items-center justify-between px-4 lg:px-8 sticky top-0 z-40 pointer-events-none">
      ...
      <div className="flex items-center gap-3 lg:gap-6 pointer-events-auto">
        <button className="p-2.5 rounded-full border border-zinc-200 text-muted-foreground hover:text-navy hover:border-indigo-200 transition-colors relative bg-white shadow-sm">
          <Bell size={18} />
        ...
        <div className="flex items-center gap-3">
          <div className="text-right hidden sm:block">
            ...
            <p className="text-[9px] text-zinc-500 uppercase tracking-[0.24em] mt-1">{user?.role}</p>
          </div>
          ...
          <div className="group relative">
            ...
            <div className="absolute right-0 top-full pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
              <div className="w-56 bg-white rounded-2xl shadow-2xl border border-zinc-200 transform origin-top-right scale-95 group-hover:scale-100 transition-transform overflow-hidden">
