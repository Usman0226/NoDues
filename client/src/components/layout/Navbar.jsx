    ...
    <nav className="h-16 lg:h-20 bg-white/80 backdrop-blur-xl border-b border-zinc-200 flex items-center justify-between px-4 lg:px-8 sticky top-0 z-40">
      <div className="flex items-center gap-3">
        <button
          ...
          className="lg:hidden min-h-11 min-w-11 inline-flex items-center justify-center -ml-1 text-navy hover:bg-zinc-100 rounded-full transition-colors"
        ...
        <div className="hidden sm:flex items-center gap-3">
          ...
          <div>
            <p className="text-[10px] font-semibold text-zinc-500">Console</p>
            <p className="text-xs lg:text-sm font-black text-navy">NoDues</p>
          </div>
        </div>
      ...
      <div className="flex items-center gap-3 lg:gap-6">
        <button
          type="button"
          className="min-h-11 min-w-11 sm:min-h-10 sm:min-w-10 inline-flex items-center justify-center rounded-full border border-zinc-200 text-muted-foreground hover:text-navy hover:border-indigo-200 transition-colors relative bg-white"
          ...
          <div className="group relative">
            ...
            <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-2xl border border-zinc-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform origin-top-right scale-95 group-hover:scale-100 overflow-hidden z-50">
              <div className="p-4 border-b border-zinc-200 bg-zinc-50/70">
                ...
                <p className="text-[10px] text-zinc-500 font-medium mt-1 sm:hidden capitalize">{user?.role}</p>
              </div>
              <button
                onClick={logout}
