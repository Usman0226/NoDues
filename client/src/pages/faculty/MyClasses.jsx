      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {classes.length === 0 ? (
          <div className="col-span-full bg-white border border-dashed border-zinc-200 rounded-3xl p-12 text-center">
            ...
            <h3 className="text-navy font-brand text-xl mb-2">No Assignments Found</h3>
            <p className="text-sm text-zinc-500 max-w-sm mx-auto">
              You are not currently assigned as a Class Teacher or Subject Faculty for any active batches. 
              Contact your HoD for assignment updates.
            </p>
          </div>
        ) : (
          classes.map((c, idx) => (
